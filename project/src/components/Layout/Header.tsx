      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className={`text-xl font-bold ${isHome ? 'text-black' : 'text-gray-900'}`}>
              Zomato
            </span>
          </Link>
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              <ShoppingBag className={`w-6 h-6 ${isHome ? 'text-black' : 'text-gray-700'}`} />
              {cartCount > 0 && (
            ...
            >
              <User className={`w-6 h-6 ${isHome ? 'text-black' : 'text-gray-700'}`} />
            </Link>
            <button
        ...
        <div className="md:hidden bg-white border-t shadow-lg">
          <nav className="px-4 py-4 space-y-2">
            ...
            <Link
              to="/favorites"
              onClick={() => setMobileMenuOpen(false)}
              className="block py-2 px-4 rounded-lg text-black-700 hover:bg-gray-100 font-medium"
            >
              Favorites
            </Link>
            <Link
